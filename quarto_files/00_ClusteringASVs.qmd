...
plot_knowns_vs_unknowns(specific_species = T,
  dm_aux = dm,df_ordered_ASVs = df_asv_species %>%
    filter(Species==vet_species[2])) + ggtitle(paste('alpha=0',vet_species[2]))

plot_knowns_vs_unknowns(specific_species = T,
  dm_aux = dm2,df_ordered_ASVs = df_asv_species %>%
    filter(Species==vet_species[2])) + ggtitle(paste('alpha=0.1',vet_species[2]))

plot_knowns_vs_unknowns(specific_species = T,
  dm_aux = dm3,df_ordered_ASVs = df_asv_species %>%
    filter(Species==vet_species[2])) + ggtitle(paste('alpha=0.25',vet_species[2]))

plot_knowns_vs_unknowns(specific_species = T,
  dm_aux = dm3,df_ordered_ASVs = df_asv_species %>%
    filter(Species==vet_species[2])) + ggtitle(paste('alpha=0.50',vet_species[2]))
```
...
plot_knowns_vs_unknowns(specific_species = T,
  dm_aux = dm,df_ordered_ASVs = df_asv_species %>%
    filter(Species==vet_species[3])) + ggtitle(paste('alpha=0',vet_species[3]))

plot_knowns_vs_unknowns(specific_species = T,
  dm_aux = dm2,df_ordered_ASVs = df_asv_species %>%
    filter(Species==vet_species[3])) + ggtitle(paste('alpha=0.1',vet_species[3]))

plot_knowns_vs_unknowns(specific_species = T,
  dm_aux = dm3,df_ordered_ASVs = df_asv_species %>%
    filter(Species==vet_species[3])) + ggtitle(paste('alpha=0.25',vet_species[3]))

plot_knowns_vs_unknowns(specific_species = T,
  dm_aux = dm3,df_ordered_ASVs = df_asv_species %>%
    filter(Species==vet_species[3])) + ggtitle(paste('alpha=0.50',vet_species[3]))
```
...
plot_knowns_vs_unknowns(specific_species = T,
  dm_aux = dm,df_ordered_ASVs = df_asv_species %>%
    filter(Species==vet_species[4])) + ggtitle(paste('alpha=0',vet_species[4]))

plot_knowns_vs_unknowns(specific_species = T,
  dm_aux = dm2,df_ordered_ASVs = df_asv_species %>%
    filter(Species==vet_species[4])) + ggtitle(paste('alpha=0.1',vet_species[4]))

plot_knowns_vs_unknowns(specific_species = T,
  dm_aux = dm3,df_ordered_ASVs = df_asv_species %>%
    filter(Species==vet_species[4])) + ggtitle(paste('alpha=0.25',vet_species[4]))

plot_knowns_vs_unknowns(specific_species = T,
  dm_aux = dm3,df_ordered_ASVs = df_asv_species %>%
    filter(Species==vet_species[4])) + ggtitle(paste('alpha=0.50',vet_species[4]))
```
...
plot_knowns_vs_unknowns(specific_species = T,
  dm_aux = dm,df_ordered_ASVs = df_asv_species %>%
    filter(Species==vet_species[5])) + ggtitle(paste('alpha=0',vet_species[5]))

plot_knowns_vs_unknowns(specific_species = T,
  dm_aux = dm2,df_ordered_ASVs = df_asv_species %>%
    filter(Species==vet_species[5])) + ggtitle(paste('alpha=0.1',vet_species[5]))

plot_knowns_vs_unknowns(specific_species = T,
  dm_aux = dm3,df_ordered_ASVs = df_asv_species %>%
    filter(Species==vet_species[5])) + ggtitle(paste('alpha=0.25',vet_species[5]))

plot_knowns_vs_unknowns(specific_species = T,
  dm_aux = dm3,df_ordered_ASVs = df_asv_species %>%
    filter(Species==vet_species[5])) + ggtitle(paste('alpha=0.50',vet_species[5]))
```
...
#simm_ait[1:5,1:5]
#simm_ait = 1/(1+inducedDist_$normalizedAitDist)
#testqgraph = qgraph::qgraph(as.matrix(simm_ait), layout='spring')
...
#| fig-height: 5
#| layout-ncol: 2
asvGroupping$barplot1
asvGroupping$barplot2
```
...
#| fig-height: 16
#| fig-align: center
asvGroupping$LatDepth_stacked + theme(legend.position = '')
```
...
#| fig-width: 12
#| fig-height: 10
asvGroupping$MDS2d_Ait_MostAbundant
```
